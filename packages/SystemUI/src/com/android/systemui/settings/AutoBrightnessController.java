...
public class AutoBrightnessController {
    ...
    private static final ColorStateList COLOR_INACTIVE = ColorStateList.valueOf(android.R.attr.colorPrimaryDark);
    ...
    public AutoBrightnessController(Context context, ImageView view) {
        mContext = context;
